...
1. `docker pull ndrpnt/dbench:1.0.0`

# Usage

1. Edit the `storageClassName` in the `dbench.yaml` file, to match your Kubernetes provider's Storage Class `kubectl get storageclasses`
...
* Danial Taracks - danial.taracks@sysdig.com
